...
export const arenaAbi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: "strategyA", type: "bytes32" },
      { name: "strategyB", type: "bytes32" },
      { name: "settled", type: "bool" },
  ...
  {
    type: "event",
    name: "CourtMatchJoined",
    inputs: [
      { indexed: true, name: "matchId", type: "uint256" },
      { indexed: true, name: "playerB", type: "address" },
      { indexed: true, name: "agentB", type: "uint256" },
      { indexed: false, name: "countryB", type: "uint8" },
      { indexed: false, name: "strategyB", type: "bytes32" },
    ],
  },
  {
    type: "function",
